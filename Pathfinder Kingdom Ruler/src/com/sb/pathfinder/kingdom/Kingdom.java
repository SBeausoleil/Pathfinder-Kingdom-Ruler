...
public class Kingdom implements Serializable {
	...
	this(name, moralAlignment, lawAlignment, government, HolidayEdict.NO_HOLIDAYS, PromotionEdict.NONE, TaxationEdict.NONE);
    }
     ...
     * @param moralAlignment the moralAlignment to set
     */
     ...
     * @param lawAlignment the lawAlignment to set
     */
     ...
     * @param mod to add to the unrest.
     */
     ...
     * @param mod to add to the economy.
     */
     ...
     * @param mod to add to the loyalty.
     */
     ...
     * @param mod to add to the stability.
     */
     ...
     * @param mod to add to the consumption.
     */
     ...
     * @param mod to add to the infamy.
     */
	...
	this.government.removeFrom(this);
        this.government = government;
        government.applyTo(this);
    }
     ...
     * @param holidayEdict the holidayEdict to set
     */
     ...
     * @param promotionEdict the promotionEdict to set
     */
     ...
     * @param taxationEdict the taxationEdict to set
     */
