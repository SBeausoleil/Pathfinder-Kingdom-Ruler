...
public class Building implements Serializable, KingdomModifier, SettlementModifier {
    ...
    public void copy(Building building) {
	// Transfer kingdom properties
	this.setUnrest(building.unrest);
	this.setEconomy(building.economy);
	this.setLoyalty(building.loyalty);
	this.setStability(building.stability);
	this.setConsumption(building.consumption);
	this.setGlory(building.glory);
	this.setInfamy(building.infamy);

	// Transfer settlement properties
	this.setCorruption(building.corruption);
	this.setCriminality(building.criminality);
	this.setLaw(building.law);
	this.setLore(building.lore);
	this.setProductivity(building.productivity);
	this.setSociety(building.society);
	this.setDefense(building.defense);
    }
